...
if __name__ == '__main__':
    s = session.query(TdPlatformAccount).filter(TdPlatformAccount.login_name == '2172765841@qq.com').one()
    # s = session.query(TdResourceAccount).get(41)
    s.cookies = "test"
    session.commit()
    print(s)
    # print(s.__dict__)
